...
Console.Clear();
double[,] matrix = CreateMultiDouble(
    GetDigit("Input numerical start of range: : "),
    GetDigit("Input numerical end of range: : ")
);
PrintMultiDouble(matrix);
FindValue(
    matrix,
    GetDigitCondition("Input the value of the row to search in the array: "),
    GetDigitCondition("Input the value of the colum to search in the array: ")
);
FindValueClassic(
    matrix,
    GetDigitCondition("Input the value of the row to search in the array: "),
